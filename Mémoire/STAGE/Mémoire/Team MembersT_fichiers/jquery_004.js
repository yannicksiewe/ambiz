...
(function($) {
    ...
    $.fn.tweetable = function(options) {
        ...
        var category = 'Twittable Content Shared';
        var action = $('h1.headline').text();
        var label = $e.text();
            
        $e.wrap("<a onclick='logGAEvent(\"" + category + "\", \"" + action + "\", \"" + label + "\")' class='" + $.tweetable.options.linkClass + "' href='" + twitterLink + "'/>");
	        return $e;
	    });
    };
